...
@WebServlet("/incomeRowInput")
public class DataInputIncomeController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (result == 1) {
			request.setAttribute("incomeInputResultMsg", "支出取引登録成功 √");
		} else {
			request.setAttribute("incomeInputResultMsg", "支出取引登録失敗 X");
		}
